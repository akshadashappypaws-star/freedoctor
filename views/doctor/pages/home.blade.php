...
<style>
    .min-h-screen, .main-content, .content-wrapper {
        padding:0!important;
        ...
        <div class="hero-container">
            <div class="hero-text">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="{{ route('doctor.campaigns') }}" class="hero-btn hero-btn-secondary">
                        <span class="material-icons">add_circle</span>
                        Post Your Camp (Doctors)
                    </a>
                    <a href="{{ route('doctor.business-reach-out') }}" class="hero-btn hero-btn-tertiary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (notifyForm) {
        notifyForm.addEventListener('submit', function(e) {
            ...
            alert('Thank you! We will notify you when a camp is available.');
        });
    }
});
</script>
